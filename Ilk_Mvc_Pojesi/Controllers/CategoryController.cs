...
namespace Ilk_Mvc_Pojesi.Controllers
{
    public class CategoryController : Controller
    {
        ...
        {
            var category = _context.Categories.Include(x => x.Products).ThenInclude(x=>x.OrderDetails).ThenInclude(x=>x.Order).FirstOrDefault(x => x.CategoryId == id);
